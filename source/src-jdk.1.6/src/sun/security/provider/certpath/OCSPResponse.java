...
public final class OCSPResponse {
    ...
    private static ResponseStatus[] values = ResponseStatus.values();
	    ...
	    if (seq.isContextSpecific((byte)1)) {
		    ...
		    if (responseExtension.getExtensionId().equals(
		        OCSP_NONCE_EXTENSION_OID)) {
                        /*
		         byte[] ocspNonce =
			     responseExtension.getExtensionValue();
                         */
	...
	AlgorithmChecker.check(sigAlgId);
        ...
        if (x509Certs != null && x509Certs[0] != null) {
            ...
            if (DEBUG != null) DEBUG.println("cert: " + cert);
	...
	private SingleResponse(DerValue der) throws 
		...
		throw new CertPathValidatorException(new UnreliableException());
	    }
	}
    ...
    public static class UnreliableException extends CertificateException {
        UnreliableException() {
            super("OCSP Response is unreliable: its validity interval " +
                  "is out-of-date");
        }
    }
}
