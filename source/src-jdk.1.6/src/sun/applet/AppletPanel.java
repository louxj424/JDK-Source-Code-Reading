...
abstract class AppletPanel extends Panel implements AppletStub, Runnable {
    ...
    abstract protected void updateHostIPFile(String codebase);
...
//          return null;
        ...
        if (code != null) {
            ...
            // serName is not null;
            applet = createSerialApplet(loader, serName);
    ...
    private static Applet createSerialApplet(final AppletClassLoader loader, final String serName) 
			throws ClassNotFoundException, IOException
    {
        try {
            ...
            return AccessController.doPrivileged(
                new PrivilegedExceptionAction<Applet>() {
