...
import sun.nio.cs.ext.IBM_EBCDIC_DBCS;
...
public class IBM1364 extends Charset
{
    ...
    static class Decoder extends IBM_EBCDIC_DBCS.Decoder {
        ...
        char decodeDouble(int b1, int b2) {
            int seg = (b1 >> 4);
            if (DB[seg] != null && b2 >= 0x40 && b2 <= 0xfe) {
                return DB[seg].charAt((b1 & 0xf) * (0xfe - 0x40 + 1) + (b2 - 0x40));
            }
            return UNMAPPABLE_DECODING;
        }
    }

    static class Encoder extends IBM_EBCDIC_DBCS.Encoder {
        private final static char[] c2b = new char[0x9c00];
        ...
        static final String b2cNR = null;
        static final String c2bNR = 
            "\u4148\u00AD\u4143\u00B7\u4149\u2015\u42A1\u223C" + 
            "\u496F\u2299\u4954\uFF5E" ;
