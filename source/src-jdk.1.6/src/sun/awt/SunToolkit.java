...
public abstract class SunToolkit extends Toolkit
    ...
    private static  Object getPrivateKey(final Object o){
        ...
        if (o instanceof Component){
            retObj = AWTAccessor.getComponentAccessor().
                         getPrivateKey((Component)o);
        } else if (o instanceof MenuComponent) {
            retObj = AWTAccessor.getMenuComponentAccessor().
                         getPrivateKey((MenuComponent)o); 
        } else if (o instanceof TrayIcon) {
            retObj = AWTAccessor.getTrayIconAccessor().
                         getPrivateKey((TrayIcon)o);
        }
        return retObj;
    }
    ...
    static private Method setMostRecentFocusOwnerMethod;
    public static void setMostRecentFocusOwner(Window window, Component component) {
        synchronized (SunToolkit.class) {
            if (setMostRecentFocusOwnerMethod == null) {
                setMostRecentFocusOwnerMethod = SunToolkit.getMethod(
                    KeyboardFocusManager.class, "setMostRecentFocusOwner",
                    new Class[] {Window.class, Component.class});
            }
        }
        try {
            setMostRecentFocusOwnerMethod.invoke(null, new Object[] {window, component});
        } catch (IllegalAccessException e) {
            e.printStackTrace();
            return;
        } catch (InvocationTargetException e) {
    ...
    /**
     * Returns the value of "sun.awt.untrustedTopLevelTranslucency" property. Default
     * value is {@code false}.
     */
    ...
    public static boolean isContainingTopLevelOpaque(Component c) {
        ...
        return c != null && AWTUtilities.isWindowOpaque((Window)c);
    }
