...
public class CMM {
    ...
    /* these are kept in the inner class to avoid initialization of CMM
       on external check for whether these fields were initialized */ 
    ...
    public static native int cmmCombineTransforms(ICC_Transform[] transforms,
                                                  ICC_Transform result);
