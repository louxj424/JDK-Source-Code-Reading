...
public class Version {
    ...
    private static final boolean java_is_embedded =
	@@java_is_embedded@@;

    private static final String java_runtime_name =
	"@@java_runtime_name@@";

    private static final String java_embedded_runtime_name =
	"Java(TM) 2 Runtime Environment, Standard Edition for Embedded";
	...
	/* Second line: runtime version (ie, libraries). */
        /* Print Embedded and Headless mode if embedded version */
        if (!java_is_embedded) {
	    ps.println(java_runtime_name + " (build " +
            ...
            if (isHeadless) {
                ps.println(java_embedded_runtime_name + " (build " +
                           java_runtime_version + ", headless)");
            }
            else {
                ps.println(java_embedded_runtime_name + " (build " +
                           java_runtime_version + ")");
