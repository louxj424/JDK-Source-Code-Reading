...
public class PooledConnection implements javax.sql.PooledConnection, PooledObject  {
  ...
  /**
    * Registers a StatementEventListener with the connection.  Components that 
    * wish to be notified when prepared statements created by the connection are 
    * detected to be invalid may use this method to register a 
    * StatementEventListener with the connection.
    * <p>
    * @param listener	an component which implements the StatementEventListener 
    * 					interface that is to be registered with the connection
    * <p>
    * @since 1.6
    */
  ...
  /**
    ...
    * componentes that will be notified when the driver detects that a 
