...
public class JdbcOdbcPreparedStatement
		...
		throws SQLException
	{
		...
		maxBytesPerChar = (int)Charset.forName(encoding).newEncoder().maxBytesPerChar();
		//System.out.println("maxBytesPerChar =  " + maxBytesPerChar + " for (" + encoding + ") encoding");
	    }
	    catch (UnsupportedCharsetException xx){}
	    catch (IllegalCharsetNameException xx){}
     ...
     * @param index of the first parameter is 1, the second is 2, ...
     * @param value the parameter value
     * @throws SQLException if the driver does not support national
     *         character sets or if the driver can detect a data
     *         corruption can occur due to this call or
     ...
     * @throws SQLException SQLException if parameterIndex does not correspond
	...
	throw new UnsupportedOperationException();
     ...
     /**
      * Sets the designated parameter to the given SQLXML object. The driver converts this to an
	...
	throw new UnsupportedOperationException();
     	...
     	/**
	 * Requests that a prepared statement be pooled or not pooled.  The value 
	 ...
	 * @since 1.6
	 * <p>
	 * @see java.sql.PreparedStatement#setPoolable(boolean) setPoolable(boolean)
	 */
