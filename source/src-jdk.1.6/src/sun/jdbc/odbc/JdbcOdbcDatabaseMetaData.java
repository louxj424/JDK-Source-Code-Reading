...
//      short tableIndexOther     = 3;
     ...
     *
     *
     * @param catalog a ctalog name; must match the catalog name as it is stored
	...
	/**
	 * Returns a result set that contains a list of the client info properties 
	 * that the driver supports.  The resultset contains the following columns
	 * <p>
	 * NAME	String; The name of the client info property<br>
	 * MAX_LEN	int; The maximum length of the value for the property<br>
	 * DEFAULT_VALUE String; The default value of the property<br>
	 ...
	 * <p>
	 * @return	A result set containing the list of client info properties
     ...
     *  <LI><B>IS_NULLABLE</B> String  => ISO rulees are used to determinte the nulliblity for a column.
     *       <UL>
     *       <LI> YES (enclosed in quotes)  --- if the parameter can include NULLs
     *       <LI> NO  (enclosed in quotes)  --- if the parameter cannot include NULLs
    ...
    public ResultSet getFunctionParameters(String catalog,
                                  ...
                                  String parameterNamePattern) throws SQLException {
       throw new UnsupportedOperationException("Operation not yet supported");
    }
